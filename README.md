...
- [참조 자료](https://poiemaweb.com/json-server)
...
- `json-server --watch db.json`
  ...
  - json-server 도 3000포트를 사용하므로 충돌 발생함.
...
- CRUD 테스트 (크러드)
  : Create(POST) Read(GET) Update(PUT/Petch) Delete(DELETE)
